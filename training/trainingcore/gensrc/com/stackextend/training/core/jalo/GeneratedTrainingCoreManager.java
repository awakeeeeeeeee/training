...
import com.stackextend.training.core.jalo.Article;
...
public abstract class GeneratedTrainingCoreManager extends Extension
{
	...
	public Article createArticle(final SessionContext ctx, final Map attributeValues)
	{
		try
		{
			ComposedType type = getTenant().getJaloConnection().getTypeManager().getComposedType( TrainingCoreConstants.TC.ARTICLE );
