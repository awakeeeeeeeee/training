...
/**
 * This is the extension manager of the Newbackoffice extension.
 */
public class NewbackofficeManager extends GeneratedNewbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(NewbackofficeManager.class);
	 ...
	 */
	public static NewbackofficeManager getInstance()
	{
		return (NewbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(NewbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public NewbackofficeManager() // NOPMD 
	{
		LOG.debug("constructor of NewbackofficeManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of NewbackofficeManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of NewbackofficeManager called, current tenant: {}", getTenant().getTenantID());
	}
