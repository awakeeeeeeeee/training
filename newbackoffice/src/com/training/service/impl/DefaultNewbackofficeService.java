...
public class DefaultNewbackofficeService implements NewbackofficeService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultNewbackofficeService.class);
	...
	{
		return DefaultNewbackofficeService.class.getResourceAsStream("/newbackoffice/sap-hybris-platform.png");
	}
