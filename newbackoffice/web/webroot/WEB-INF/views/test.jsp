...
<html>
<head>
    <title>Welcome to newbackoffice</title>
...
<div class="container">
    ...
    <h2>Welcome to "newbackoffice" extension</h2>
    ...
    <div>
        ...
        <ul>
            <li><b>resources/newbackoffice-items.xml</b> - here you can model your items</li>
            <li><b>resources/newbackoffice-spring.xml</b> - here you can define your services</li>
            <li><b>web/webroot/WEB-INF/config/newbackoffice-spring-mvc-config.xml</b> - here is a Spring MVC related
                configuration
            </li>
            <li><b>web/webroot/WEB-INF/config/newbackoffice-web-app-config.xml</b> - here you can define web related services,
                facades etc.
            </li>
            <li><b>web/webroot/WEB-INF/config/newbackoffice-spring-security-config.xml</b> - here you can configure your Spring Security settings</li>
