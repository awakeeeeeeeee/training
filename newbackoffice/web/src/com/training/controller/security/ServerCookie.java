...
public class ServerCookie implements Serializable
{
	...
	protected static boolean hasCookieSupport(final String value)
	{
		return !CookieSupport.ALLOW_HTTP_SEPARATORS_IN_V0 && CookieSupport.isHttpToken(value)
	 ...
	 * add next char if this was not the end of passed string. If charString '"', then escape it with \\. All other will
	 * just append charString param.
	 *
	...
	protected static boolean modifyDoubleQuotesChar(final String processedString, final int endIndex, final StringBuilder result,
			final int stringIndex, final char charString)
	{
		if (charString == '\\')
		{
	...
	public static final class CookieSupport
	{
		...
		static
		{
			...
			ALLOW_NAME_ONLY = Boolean
					.parseBoolean(System.getProperty("org.apache.tomcat.util.http.ServerCookie.ALLOW_NAME_ONLY", DEFAULT_FALSE_VALUE));
